...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-156282b487cf5c34"
    ],
    "allowed_axioms": [
    ...
    "domain": {
      "description": "Draft source observation in Number theory, Additive number theory; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:wikipedia-156282b487cf5c34",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-156282b487cf5c34",
        "url": "https://en.wikipedia.org/wiki/Lemoine%27s_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Lemoine's conjecture : all odd integers greater than $5$ can be represented as the sum of an odd prime number and an even semiprime .",
      "version": 1
    },
    "title": "Lemoine's conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "cfeb5b3597530ccad317ffbbf74ebb6a40be0c61898f5d93d5ab937e09c2d990"
}
```
